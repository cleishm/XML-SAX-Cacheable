# Test that caching works via a Cache::Memory::Entry.  The consumer/generator
# records SAX events and replays them.  This test checks that everything works
# with the PurePerl parser supplying the initial SAX stream.
#
use strict;
use warnings;
